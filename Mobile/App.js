...
export default function App() {
  ...
  useEffect(() => {
    ...
    console.log(
      'Attempting to connect with options:',
    ...
    try {
      ...
      mqttClient.on('connect', function () {
        ...
        mqttClient.publish('home/zwave/getAll', 'Request');
      });
            ...
            <View style={styles.statusRow}>
              ...
              <View style={styles.statusItem}>
                <Icon
                  name="power"
                  size={24}
                  color={thermostatPowerStatus === 'on' ? '#4CAF50' : '#F44336'}
                />
                <View>
                  <Text style={styles.statusLabel}>Thermostat</Text>
                  <Text style={styles.statusValue}>
                    {thermostatPowerStatus}
                  </Text>
                </View>
              </View>
            </View>
    ...
    <View style={styles.controlContainer}>
      <Card style={styles.controlCard}>
        <Card.Content style={styles.controlContent}>
          <Icon
            name={isPoweredOn ? 'lightbulb' : 'lightbulb-off'}
            size={80}
            color={isPoweredOn ? '#FFC107' : '#9E9E9E'}
          />
          <Text style={styles.controlTitle}>
            Lights are {isPoweredOn ? 'on' : 'off'}
          </Text>
          ...
          <TouchableOpacity
            ...
            onPress={togglePower}>
            <Icon
              name={isPoweredOn ? 'power-off' : 'power'}
              size={24}
              color="#fff"
            />
  ...
  function handleThermostatControl(thermostatType) {
    ...
    if (tempNum !== '' && tempNum >= 68 && tempNum <= 75) {
      client.publish(
        ...
        thermostatType + ': ' + temperatureInput
      );
        ...
        <Card.Content>
          <View style={styles.powerStatus}>
            <Icon
              name="power"
              size={30}
              color={isPoweredOn ? '#4CAF50' : '#F44336'}
            />
            <Text
              style={[
                styles.powerStatusText,
                isPoweredOn ? styles.powerOnText : styles.powerOffText,
              ]}>

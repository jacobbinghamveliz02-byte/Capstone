...
var SetApplicationNodeInformationRequest_exports = {};
__export(SetApplicationNodeInformationRequest_exports, {
  SetApplicationNodeInformationRequest: () => SetApplicationNodeInformationRequest
});
module.exports = __toCommonJS(SetApplicationNodeInformationRequest_exports);
...
let SetApplicationNodeInformationRequest = (() => {
  let _classDecorators = [(0, import_serial.messageTypes)(import_serial.MessageType.Request, import_serial.FunctionType.SetApplicationNodeInformation), (0, import_serial.priority)(import_core.MessagePriority.Controller)];
  let _classDescriptor;
  let _classExtraInitializers = [];
  let _classThis;
  let _classSuper = import_serial.Message;
  var SetApplicationNodeInformationRequest2 = class extends _classSuper {
    static {
      __name(this, "SetApplicationNodeInformationRequest");
    }
    static {
      _classThis = this;
    }
    static {
      ...
      SetApplicationNodeInformationRequest2 = _classThis = _classDescriptor.value;
...
\xB7 ${(0, import_core.getCCName)(cc)}`).join(""),
          "controlled CCs": this.controlledCCs.map((cc) => `
\xB7 ${(0, import_core.getCCName)(cc)}`).join("")
        }
      };
    }
  };
  return SetApplicationNodeInformationRequest2 = _classThis;
})();

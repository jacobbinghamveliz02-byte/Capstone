...
import { MessagePriority, encodeCCList, getCCName, } from "@zwave-js/core";
...
let SetApplicationNodeInformationRequest = (() => {
    let _classDecorators = [messageTypes(MessageType.Request, FunctionType.SetApplicationNodeInformation), priority(MessagePriority.Controller)];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = Message;
    var SetApplicationNodeInformationRequest = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            SetApplicationNodeInformationRequest = _classThis = _classDescriptor.value;
    ...
    return SetApplicationNodeInformationRequest = _classThis;
})();
export { SetApplicationNodeInformationRequest };

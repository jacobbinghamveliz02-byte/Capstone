...
let ExtNVMWriteLongByteRequest = (() => {
    let _classDecorators = [messageTypes(MessageType.Request, FunctionType.ExtExtWriteLongByte), priority(MessagePriority.Controller), expectedResponse(FunctionType.ExtExtWriteLongByte)];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = Message;
    var ExtNVMWriteLongByteRequest = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            ExtNVMWriteLongByteRequest = _classThis = _classDescriptor.value;
        ...
        constructor(options) {
            ...
            if ((options.byte & 0xff) !== options.byte) {
                throw new ZWaveError("The data must be a byte!", ZWaveErrorCodes.Argument_Invalid);
            }
    ...
    return ExtNVMWriteLongByteRequest = _classThis;
})();
export { ExtNVMWriteLongByteRequest };
let ExtNVMWriteLongByteResponse = (() => {
    let _classDecorators = [messageTypes(MessageType.Response, FunctionType.ExtExtWriteLongByte)];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = Message;
    var ExtNVMWriteLongByteResponse = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            ExtNVMWriteLongByteResponse = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            __runInitializers(_classThis, _classExtraInitializers);
        }
        constructor(options) {
    ...
    return ExtNVMWriteLongByteResponse = _classThis;
})();
export { ExtNVMWriteLongByteResponse };

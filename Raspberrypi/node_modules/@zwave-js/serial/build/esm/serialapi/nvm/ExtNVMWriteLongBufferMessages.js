...
let ExtNVMWriteLongBufferRequest = (() => {
    let _classDecorators = [messageTypes(MessageType.Request, FunctionType.ExtNVMWriteLongBuffer), priority(MessagePriority.Controller), expectedResponse(FunctionType.ExtNVMWriteLongBuffer)];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = Message;
    var ExtNVMWriteLongBufferRequest = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            ExtNVMWriteLongBufferRequest = _classThis = _classDescriptor.value;
        ...
        constructor(options) {
            ...
            if (options.buffer.length < 1 || options.buffer.length > 0xffff) {
                throw new ZWaveError("The buffer must be between 1 and 65535 bytes long", ZWaveErrorCodes.Argument_Invalid);
            }
    ...
    return ExtNVMWriteLongBufferRequest = _classThis;
})();
export { ExtNVMWriteLongBufferRequest };
let ExtNVMWriteLongBufferResponse = (() => {
    let _classDecorators = [messageTypes(MessageType.Response, FunctionType.ExtNVMWriteLongBuffer)];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = Message;
    var ExtNVMWriteLongBufferResponse = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            ExtNVMWriteLongBufferResponse = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            __runInitializers(_classThis, _classExtraInitializers);
        }
        constructor(options) {
    ...
    return ExtNVMWriteLongBufferResponse = _classThis;
})();
export { ExtNVMWriteLongBufferResponse };

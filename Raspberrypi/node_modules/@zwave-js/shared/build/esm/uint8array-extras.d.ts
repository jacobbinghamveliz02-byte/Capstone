...
export declare function isUint8ArrayOrArrayBuffer(value: unknown): value is Uint8Array<ArrayBuffer> | ArrayBuffer;
export declare function isUint8ArrayOrArrayLike(value: unknown): value is Uint8Array<ArrayBuffer> | ArrayLike<number>;
/**
...
```
*/
export declare function assertUint8Array(value: unknown): asserts value is Uint8Array<ArrayBuffer>;
export declare function assertUint8ArrayOrArrayBuffer(value: unknown): asserts value is Uint8Array<ArrayBuffer> | ArrayBuffer;
export declare function assertUint8ArrayOrArrayLike(value: unknown): asserts value is Uint8Array<ArrayBuffer> | ArrayLike<number>;
/**
...
```
*/
export declare function concatUint8Arrays(arrays: readonly (Uint8Array | ArrayLike<number>)[], totalLength?: number): Uint8Array<ArrayBuffer>;
/**
...
```
*/
export declare function compareUint8Arrays(a: Uint8Array, b: Uint8Array): 0 | 1 | -1;
/**
...
```
*/
export declare function uint8ArrayToBase64(array: Uint8Array, options?: {
    urlSafe: boolean;
}): string;
/**
...
```
*/
export declare function stringToBase64(string: string, options?: {
    urlSafe: boolean;
}): string;
/**
...
```
*/
export declare function hexToUint8Array(hexString: string): Uint8Array<ArrayBuffer>;
/**
...
//# sourceMappingURL=uint8array-extras.d.ts.map
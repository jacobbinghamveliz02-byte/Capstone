...
class Bytes extends Uint8Array {
  ...
  equals(other) {
    return (0, import_uint8array_extras.areUint8ArraysEqual)(this, other);
  }
  /**
  ...
  static from(data, encodingOrMapfn, thisArg) {
    if (typeof data === "string") {
      ...
      switch (encoding) {
        ...
        case "utf8":
        case void 0:
          return Bytes.view((0, import_uint8array_extras.stringToUint8Array)(data));
        case "hex":
          return Bytes.view((0, import_uint8array_extras.hexToUint8Array)(data));
        case "base64":
          return Bytes.view((0, import_uint8array_extras.base64ToUint8Array)(data));
      }
      throw new Error(`Unsupported encoding: ${encoding}`);
    } else if ((0, import_uint8array_extras.isUint8ArrayOrArrayBuffer)(data)) {
      return new Bytes(data);
    } else if ("length" in data) {
      return Bytes.view(super.from(data));
    } else {
      return Bytes.view(super.from(data, encodingOrMapfn, thisArg));
    }
  }
  /**
  ...
  toString(encoding = "utf8") {
    switch (encoding) {
      case "hex":
        return (0, import_uint8array_extras.uint8ArrayToHex)(this);
      case "base64":
        return (0, import_uint8array_extras.uint8ArrayToBase64)(this);
      case "base64url":
        return (0, import_uint8array_extras.uint8ArrayToBase64)(this, { urlSafe: true });
      case "ucs-2":
      case "ucs2":
      case "utf16le":
        return (0, import_uint8array_extras.uint8ArrayToString)(this, "utf-16le");
      case "ascii":
      case "latin1":
      case "binary":
      ...
      default:
        return (0, import_uint8array_extras.uint8ArrayToString)(this, "utf-8");
    }
  }
  subarray(start, end) {
  ...
  includes(value, byteOffset = 0) {
    if (typeof value === "number") {
      ...
      return (0, import_uint8array_extras.includes)(this.subarray(byteOffset), value);
    } else {
      return (0, import_uint8array_extras.includes)(this, value);
    }
  }
  // /**
  ...
  static concat(list, totalLength) {
    return Bytes.view((0, import_uint8array_extras.concatUint8Arrays)(list, totalLength));
  }
  getDataView() {

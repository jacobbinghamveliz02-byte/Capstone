...
export interface CryptoPrimitives {
    ...
    encryptAES128CBC(plaintext: BytesView, key: BytesView, iv: BytesView): Promise<BytesView>;
    /** Encrypts a payload using AES-128-OFB */
    encryptAES128OFB(plaintext: BytesView, key: BytesView, iv: BytesView): Promise<BytesView>;
    /** Decrypts a payload using AES-128-OFB */
    decryptAES128OFB(ciphertext: BytesView, key: BytesView, iv: BytesView): Promise<BytesView>;
    /** Decrypts a payload using AES-256-CBC */
    decryptAES256CBC(ciphertext: BytesView, key: BytesView, iv: BytesView): Promise<BytesView>;
    /** Encrypts and authenticates a payload using AES-128-CCM */
    encryptAES128CCM(plaintext: BytesView, key: BytesView, iv: BytesView, additionalData: BytesView, authTagLength: number): Promise<{
    ...
    digest(algorithm: "md5" | "sha-1" | "sha-256", data: BytesView): Promise<BytesView>;
    ...
    encryptChaCha20Poly1305(key: BytesView, nonce: BytesView, additionalData: BytesView, plaintext: BytesView): Promise<{
        ciphertext: BytesView;
        authTag: BytesView;
    }>;
    /** Decrypts and verifies a payload using ChaCha20-Poly1305 */
    decryptChaCha20Poly1305(key: BytesView, nonce: BytesView, additionalData: BytesView, ciphertext: BytesView, authTag: BytesView): Promise<{
        plaintext: BytesView;
        authOK: boolean;
    }>;
...
export interface FileSystem extends ReadFile, WriteFile, CopyFile, OpenFile, ReadFileSystemInfo, ManageDirectory, MakeTempDirectory {
}

...
export function getNumericEnumValues(enumeration) {
...
export function enumValuesToMetadataStates(enumeration, values) {
    const ret = {};
    if (values == undefined)
...
const defineTimeout = define();
/**
 * Defines how a configuration value is encoded
 */
export var ConfigValueFormat;

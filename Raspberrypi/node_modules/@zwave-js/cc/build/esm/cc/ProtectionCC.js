...
import * as __validateArgs from "./ProtectionCC._validateArgs.js";
...
import { ProtectionCCValues } from "./_CCValues.generated.js";
export { ProtectionCCValues };
let ProtectionCCAPI = (() => {
...
let ProtectionCCSet = (() => {
    let _classDecorators = [CCCommand(ProtectionCommand.Set), expectedCCResponse(getCCResponseForProtectionCCSet), useSupervision()];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;

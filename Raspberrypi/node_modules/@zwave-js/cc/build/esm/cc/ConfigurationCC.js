...
import * as __validateArgs from "./ConfigurationCC._validateArgs.js";
...
import { ConfigurationCCValues } from "./_CCValues.generated.js";
export { ConfigurationCCValues };
...
alters capabilities: ${!!properties.altersCapabilities}`;
        ...
        async applyRecommendedValues(ctx, node, paramInfo, api) {
            ...
            for (const [paramKey, param] of paramInfo) {
                ...
                const currentValue = this.getValue(ctx, ConfigurationCCValues.paramInformation(paramKey.parameter, paramKey.valueBitMask));
                ...
                if (currentValue === param.defaultValue
                    ...
                    parametersNeededUpdate.push(param.valueBitMask !== undefined
...
let ConfigurationCCReport = (() => {
    ...
    var ConfigurationCCReport = class extends _classSuper {
        ...
        persistValues(ctx) {
            ...
            const paramInfo = getParamInformationFromConfigFile(ctx, this.nodeId, this.endpointIndex);
...
function getResponseForBulkSet(ctx, cc) {
...
let ConfigurationCCInfoReport = (() => {
    ...
    var ConfigurationCCInfoReport = class extends _classSuper {
        ...
        persistValues(ctx) {
            ...
            const partialParams = this.getPartialParamInfos(ctx, this.parameter).toSorted((a, b) => (a.propertyKey ?? 0)
                - (b.propertyKey ?? 0));
            if (partialParams.length === 0) {
                this.extendParamInformation(ctx, this.parameter, undefined, {
...
let ConfigurationCCDefaultReset = (() => {
    let _classDecorators = [CCCommand(ConfigurationCommand.DefaultReset), useSupervision()];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = ConfigurationCC;

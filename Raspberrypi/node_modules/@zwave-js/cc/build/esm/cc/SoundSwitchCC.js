...
import * as __validateArgs from "./SoundSwitchCC._validateArgs.js";
...
import { SoundSwitchCCValues } from "./_CCValues.generated.js";
export { SoundSwitchCCValues };
let SoundSwitchCCAPI = (() => {
    ...
    var SoundSwitchCCAPI = class extends _classSuper {
        ...
        get [(_getToneInfo_decorators = [validateArgs_SoundSwitchCCAPI_getToneInfo()], _setConfiguration_decorators = [validateArgs_SoundSwitchCCAPI_setConfiguration()], _play_decorators = [validateArgs_SoundSwitchCCAPI_play()], SET_VALUE)]() {
...
duration: ${info.duration} seconds`;
         ...
         */
        static getToneDurationCached(ctx, endpoint, toneId) {
            const valueDb = ctx.getValueDB(endpoint.nodeId);
            const toneIdValueId = SoundSwitchCCValues.toneId.endpoint(endpoint.index);
         ...
         */
        static getToneNameCached(ctx, endpoint, toneId) {
            const valueDb = ctx.getValueDB(endpoint.nodeId);
            const toneIdValueId = SoundSwitchCCValues.toneId.endpoint(endpoint.index);
            const metadata = valueDb.getMetadata(toneIdValueId);

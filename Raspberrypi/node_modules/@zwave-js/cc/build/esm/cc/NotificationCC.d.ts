...
export declare class NotificationCCAPI extends PhysicalCCAPI {
    ...
    get(options: NotificationCCGetOptions): Promise<Pick<NotificationCCReport, "alarmLevel" | "notificationStatus" | "notificationEvent" | "eventParameters" | "sequenceNumber"> | undefined>;

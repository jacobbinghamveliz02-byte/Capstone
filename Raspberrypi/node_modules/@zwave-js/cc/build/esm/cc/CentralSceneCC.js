...
import * as __validateArgs from "./CentralSceneCC._validateArgs.js";
...
import { CentralSceneCCValues } from "./_CCValues.generated.js";
export { CentralSceneCCValues };
let CentralSceneCCAPI = (() => {
    ...
    var CentralSceneCCAPI = class extends _classSuper {
        ...
        get [(_setConfiguration_decorators = [validateArgs_CentralSceneCCAPI_setConfiguration()], SET_VALUE)]() {
...
let CentralSceneCCNotification = (() => {
    ...
    var CentralSceneCCNotification = class extends _classSuper {
        ...
        persistValues(ctx) {
            ...
            const sceneConfig = ctx.getDeviceConfig?.(this.nodeId)

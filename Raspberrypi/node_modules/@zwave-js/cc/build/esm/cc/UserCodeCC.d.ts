...
export declare function userCodeToLogString(userCode: string | BytesView): string;
export declare class UserCodeCCAPI extends PhysicalCCAPI {
    ...
    set(userId: number, userIdStatus: Exclude<UserIDStatus, UserIDStatus.Available | UserIDStatus.StatusNotAvailable>, userCode: string | BytesView): Promise<SupervisionResult | undefined>;

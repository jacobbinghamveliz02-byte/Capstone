import type { BatteryReplacementStatus, EntryControlDataTypes, EntryControlEventTypes, FirmwareUpdateProgress, FirmwareUpdateResult, MultilevelSwitchCommand, Powerlevel, PowerlevelTestStatus, Weekday } from "@zwave-js/cc";
import type { NotificationCCReport } from "@zwave-js/cc/NotificationCC";
import type { CommandClasses, MetadataUpdatedArgs, NodeStatus, TranslatedValueID, ValueAddedArgs, ValueNotificationArgs, ValueRemovedArgs, ValueUpdatedArgs } from "@zwave-js/core";
...
export declare enum LinkReliabilityCheckMode {
    BasicSetOnOff = 0
}

import { type DataDirection, type LogContainer, type LogContext, ZWaveLoggerBase } from "@zwave-js/core";
import { type Message, type ResponseRole } from "@zwave-js/serial";
...
export declare class DriverLogger extends ZWaveLoggerBase<DriverLogContext> {
    ...
    constructor(driver: Driver, loggers: LogContainer);
